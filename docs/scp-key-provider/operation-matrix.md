...
chainable derivation implements the same operation contract. Card SCP03 S8 and
SCP11a/b/c derivation also use `Pkcs11Auth`; fixed vectors, software and native
providers, and physical YubiKey SCP qualification cover that path.
