...
type MessageDigest = software_key_core::digest::HashAlgorithm;

fn hash(digest: MessageDigest, data: &[u8]) -> Result<Vec<u8>, Error> {
    Ok(digest.digest(data))
}
...
const CKK_YUBICO_YUBIHSM_AUTHENTICATION_KEY_SYMMETRIC: CK_KEY_TYPE =
    CKK_VENDOR_DEFINED as CK_KEY_TYPE | YUBICO_BASE_VENDOR | 38;
const CKK_YUBICO_YUBIHSM_AUTHENTICATION_KEY_ASYMMETRIC: CK_KEY_TYPE =
    CKK_VENDOR_DEFINED as CK_KEY_TYPE | YUBICO_BASE_VENDOR | 39;
const CKK_YUBICO_HSMAUTH_CREDENTIAL_SYMMETRIC: CK_KEY_TYPE =
    CKK_VENDOR_DEFINED as CK_KEY_TYPE | YUBICO_BASE_VENDOR | 0x100;
const CKK_YUBICO_HSMAUTH_CREDENTIAL_ASYMMETRIC: CK_KEY_TYPE =
    CKK_VENDOR_DEFINED as CK_KEY_TYPE | YUBICO_BASE_VENDOR | 0x101;
