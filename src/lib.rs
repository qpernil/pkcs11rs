...
#[test]
fn test_C_Initialize() {
    let rv = C_Initialize(::std::ptr::null_mut());
    assert_eq!(rv, CKR_OK.into());
}
...
extern "C" {
    pub fn C_Finalize(pReserved: *mut ::std::os::raw::c_void) -> CK_RV;
}
pub type CK_C_GetInfo = ::std::option::Option<unsafe extern "C" fn(info: *mut _CK_INFO) -> CK_RV>;
extern "C" {
    pub fn C_GetInfo(info: *mut _CK_INFO) -> CK_RV;
}
pub type CK_C_GetFunctionList =
    ...
    >;
extern "C" {
    pub fn C_GetFunctionList(function_list: *mut *mut _CK_FUNCTION_LIST) -> CK_RV;
}
...
>;
extern "C" {
    pub fn C_GetSlotInfo(slotID: CK_SLOT_ID, info: *mut _CK_SLOT_INFO) -> CK_RV;
}
...
>;
extern "C" {
    pub fn C_GetTokenInfo(slotID: CK_SLOT_ID, info: *mut _CK_TOKEN_INFO) -> CK_RV;
}
...
pub type CK_C_GetSessionInfo =
    ...
    >;
extern "C" {
    pub fn C_GetSessionInfo(session: CK_SESSION_HANDLE, info: *mut _CK_SESSION_INFO) -> CK_RV;
}
