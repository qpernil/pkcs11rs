...
#define CKK_YUBICO_YUBIHSM_AUTHENTICATION_KEY_SYMMETRIC \
  (CKK_VENDOR_DEFINED | PKCS11RS_YUBICO_BASE_VENDOR | 38UL)
#define CKK_YUBICO_YUBIHSM_AUTHENTICATION_KEY_ASYMMETRIC \
  (CKK_VENDOR_DEFINED | PKCS11RS_YUBICO_BASE_VENDOR | 39UL)
#define CKK_YUBICO_HSMAUTH_CREDENTIAL_SYMMETRIC \
  (CKK_VENDOR_DEFINED | PKCS11RS_YUBICO_BASE_VENDOR | 0x100UL)
#define CKK_YUBICO_HSMAUTH_CREDENTIAL_ASYMMETRIC \
  (CKK_VENDOR_DEFINED | PKCS11RS_YUBICO_BASE_VENDOR | 0x101UL)
#define CKA_YUBICO_HSMAUTH_RETRIES (CKA_VENDOR_DEFINED | 0x5902UL)
#define CKA_YUBICO_HSMAUTH_TOUCH_REQUIRED (CKA_VENDOR_DEFINED | 0x5903UL)
