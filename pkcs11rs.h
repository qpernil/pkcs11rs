...
#define PKCS11RS_PREVIEW_SIGN_BASE_VENDOR 0x50530000UL
#define CKM_PKCS11RS_PREVIEW_SIGN_KEY_PAIR_GEN \
  (CKM_VENDOR_DEFINED | PKCS11RS_PREVIEW_SIGN_BASE_VENDOR | 1UL)
#define CKM_PKCS11RS_PREVIEW_SIGN_DERIVE \
  (CKM_VENDOR_DEFINED | PKCS11RS_PREVIEW_SIGN_BASE_VENDOR | 2UL)
#define CKM_PKCS11RS_PREVIEW_SIGN \
  (CKM_VENDOR_DEFINED | PKCS11RS_PREVIEW_SIGN_BASE_VENDOR | 3UL)
#define CKK_PKCS11RS_PREVIEW_SIGN_REGISTRATION \
  (CKK_VENDOR_DEFINED | PKCS11RS_PREVIEW_SIGN_BASE_VENDOR | 1UL)
#define CKA_PKCS11RS_PREVIEW_SIGN_REGISTRATION \
  (CKA_VENDOR_DEFINED | PKCS11RS_PREVIEW_SIGN_BASE_VENDOR | 1UL)
#define CKA_PKCS11RS_PREVIEW_SIGN_DERIVED_KEY \
  (CKA_VENDOR_DEFINED | PKCS11RS_PREVIEW_SIGN_BASE_VENDOR | 2UL)
